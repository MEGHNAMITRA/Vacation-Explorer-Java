...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String[] text=new String[]{"JW Marriott Hotel","Mandarin Oriental Hotel","Four Seasons Hotel","Radisson Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blows Hotel","The Taj Hotel","Happy Mornings Motel","River View Hotel"};
        try{
          for(int i=0;i<=9;i++){
