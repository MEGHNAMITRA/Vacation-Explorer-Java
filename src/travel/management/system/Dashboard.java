...
public class Dashboard extends JFrame implements ActionListener{
    String username;
    JButton addPersonalDetails, viewPersonalDetails,updatePersonalDetails,checkpackages,bookpackages,viewpackage,viewhotels,destination,bookhotels,
            viewBookhotels,payments,calculators,notepad,about,deletePersonalDetails;
    ...
    Dashboard(String username){
        ...
        JLabel text=new JLabel("Vacation Explorer Java");
